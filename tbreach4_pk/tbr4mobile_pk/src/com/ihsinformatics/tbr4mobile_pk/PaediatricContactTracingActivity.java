...
//				startActivity (intent);
	...
	public void onClick(View view)
	{
		...
		else if( view == validatePatientId)
		{
			...
			if (!patId.equals (""))
			{
				AsyncTask<String, String, String[][]> getTask = new AsyncTask<String, String, String[][]> ()
				{
					...
					protected void onPostExecute (String[][] result)
					{
						...
						{
							saveButton.setEnabled(false);
							App.getAlertDialog (PaediatricContactTracingActivity.this, AlertType.ERROR, App.get(indexCaseId) +": " + getResources ().getString (R.string.item_not_found)).show ();
						}
					}
				};
				getTask.execute ("");
			...
			{
				App.getAlertDialog (this, AlertType.ERROR, App.get(indexCaseId) + ": " + getResources ().getString (R.string.empty_data)).show ();
			}
		}
	}
