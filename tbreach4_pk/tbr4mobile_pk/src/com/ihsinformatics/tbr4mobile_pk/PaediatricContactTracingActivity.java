...
public class PaediatricContactTracingActivity extends AbstractFragmentActivity implements OnEditorActionListener
{
	 ...
	 * 
	 */
	class PaediatricContactTracingFragmentPagerAdapter extends FragmentPagerAdapter
	{
		/** Constructor of the class */
		public PaediatricContactTracingFragmentPagerAdapter (FragmentManager fragmentManager)
		{
	...
	public void createViews(Context context)
	{
		...
		PaediatricContactTracingFragmentPagerAdapter pagerAdapter = new PaediatricContactTracingFragmentPagerAdapter (fragmentManager);
		...
		visitTypeTextView = new MyTextView(context, R.style.text, R.string.visit_type);
		visitType = new MySpinner(context, getResources().getStringArray(R.array.visit_type_options), R.string.visit_type, R.string.option_hint);
...
//		indexDistrictTbNumber = new MyEditText(context, R.string.index_district_number, R.string.index_district_number_hint, InputType.TYPE_CLASS_TEXT, R.style.edit, 12, false);
		...
		weightPercentileTextView = new MyTextView(context, R.style.text, R.string.weight_percentile);
		weightPercentile = new MySpinner(context, getResources().getStringArray(R.array.weight_percentile_options), R.string.weight_percentile, R.string.option_hint);
		
		coughTextView = new MyTextView (context, R.style.text, R.string.contact_cough);
		cough = new MySpinner (context, getResources ().getStringArray (R.array.four_options), R.string.child_cough, R.string.option_hint);
		coughDurationTextView = new MyTextView (context, R.style.text, R.string.contact_cough_duration);
		coughDuration = new MySpinner (context, getResources ().getStringArray (R.array.child_cough_durations), R.string.contact_cough_duration, R.string.option_hint);

		feverTextView = new MyTextView (context, R.style.text, R.string.contact_fever);
		fever = new MySpinner (context, getResources ().getStringArray (R.array.four_options), R.string.contact_fever, R.string.option_hint);
		
		nightSweatsTextView = new MyTextView(context, R.style.text, R.string.contact_night_sweats);
		nightSweats = new MySpinner(context, getResources().getStringArray(R.array.four_options), R.string.contact_night_sweats, R.string.option_hint);
		
		weightLossTextView = new MyTextView(context, R.style.text, R.string.contact_weight_loss);
		...
		lymphNodeExaminationTextView = new MyTextView(context, R.style.text, R.string.lymph_node_exam);
		lymphNodeExamination = new MySpinner(context, getResources().getStringArray(R.array.chest_exam_options), R.string.lymph_node_exam, R.string.option_hint);
		
		abdominalExaminationTextView = new MyTextView(context, R.style.text, R.string.abdominal_exam);
		abdominalExamination = new MySpinner(context, getResources().getStringArray(R.array.chest_exam_options), R.string.abdominal_exam, R.string.option_hint);
		
		otherExaminationTextView = new MyTextView(context, R.style.text, R.string.other_exam);
		otherExamination = new MyEditText(context, R.string.other_exam, R.string.other_exam_hint, InputType.TYPE_CLASS_TEXT, R.style.edit, 25, false);
		
		childBcgScarTextView = new MyTextView(context, R.style.text, R.string.child_bcg_scar);
		childBcgScar = new MySpinner(context, getResources().getStringArray(R.array.four_options), R.string.child_bcg_scar, R.string.option_hint);
		
		adultFamilyMemberTBTextView = new MyTextView(context, R.style.text, R.string.adult_family_member_tb);
		adultFamilyMemberTB = new MySpinner(context, getResources().getStringArray(R.array.four_options), R.string.adult_family_member_tb, R.string.option_hint);
		
		memberFamilyTBTextView = new MyTextView(context, R.style.text, R.string.member_family_tb);
		memberFamilyTB = new MySpinner(context, getResources().getStringArray(R.array.family_members), R.string.member_family_tb, R.string.option_hint);
		
		memberTBFormTextView = new MyTextView(context, R.style.text, R.string.member_tb_form);
		memberTBForm = new MySpinner(context, getResources().getStringArray(R.array.tb_forms), R.string.member_tb_form, R.string.option_hint);
		
		memberTBTypeTextView = new MyTextView(context, R.style.text, R.string.member_tb_type);
		memberTBType = new MySpinner(context, getResources().getStringArray(R.array.tb_types), R.string.member_tb_type, R.string.option_hint);

		confirmSputumSmearPositiveTBTextView = new MyTextView(context, R.style.text, R.string.sputum_smear_positive_tb);
		confirmSputumSmearPositiveTB = new MySpinner(context, getResources().getStringArray(R.array.four_options), R.string.sputum_smear_positive_tb, R.string.option_hint);
		
		exposureScoreTextView = new MyTextView(context, R.style.text, R.string.exposure_score);
		exposureScore = new MyTextView(context, R.style.text, R.string.exposure_value);
		//exposureScore = new MyEditText(context, R.string.exposure_score, R.string.exposure_score_hint, InputType.TYPE_CLASS_NUMBER, R.style.edit, 3, false);
		
		exposureScoreTextView1 = new MyTextView(context, R.style.text, R.string.exposure_score);
		exposureScore1 = new MyTextView(context, R.style.text, R.string.exposure_value);
//		exposureScore1 = new MyEditText(context, R.string.exposure_score, R.string.exposure_score_hint, InputType.TYPE_CLASS_NUMBER, R.style.edit, 3, false);

		exposureScoreTextView2 = new MyTextView(context, R.style.text, R.string.exposure_score);
		exposureScore2 = new MyTextView(context, R.style.text, R.string.exposure_value);
//		exposureScore2 = new MyEditText(context, R.string.exposure_score, R.string.exposure_score_hint, InputType.TYPE_CLASS_NUMBER, R.style.edit, 3, false);

		exposureScoreTextView3 = new MyTextView(context, R.style.text, R.string.exposure_score);
...
//		exposureScore3 = new MyEditText(context, R.string.exposure_score, R.string.exposure_score_hint, InputType.TYPE_CLASS_NUMBER, R.style.edit, 3, false);
		...
		sourceCasePrimaryCareGiverTextView = new MyTextView(context, R.style.text, R.string.source_case_primary_care_giver);
		sourceCasePrimaryCareGiver = new MySpinner(context, getResources().getStringArray(R.array.four_options), R.string.source_case_primary_care_giver, R.string.option_hint);
		
		sourceCaseSleepSameBedTextView = new MyTextView(context, R.style.text, R.string.source_case_sleep_same_bed);
		sourceCaseSleepSameBed = new MySpinner(context, getResources().getStringArray(R.array.four_options), R.string.source_case_sleep_same_bed, R.string.option_hint);
		
		sourceCaseSleepSameRoomTextView = new MyTextView(context, R.style.text, R.string.source_case_sleep_same_room);
		sourceCaseSleepSameRoom = new MySpinner(context, getResources().getStringArray(R.array.four_options), R.string.source_case_sleep_same_room, R.string.option_hint);
		
		sourceCaseLiveSameHouseholdTextView = new MyTextView(context, R.style.text, R.string.source_case_live_same_household);
		sourceCaseLiveSameHousehold = new MySpinner(context, getResources().getStringArray(R.array.four_options), R.string.source_case_live_same_household, R.string.option_hint);
		
		sourceCaseSeeChildEverydayTextView = new MyTextView(context, R.style.text, R.string.source_case_see_child_everyday);
		sourceCaseSeeChildEveryday = new MySpinner(context, getResources().getStringArray(R.array.four_options), R.string.source_case_see_child_everyday, R.string.option_hint);
		
		sourceCaseCoughingTextView = new MyTextView(context, R.style.text, R.string.source_case_coughing);
		sourceCaseCoughing = new MySpinner(context, getResources().getStringArray(R.array.four_options), R.string.source_case_coughing, R.string.option_hint);
		
		sourceCaseHasPulmonaryTBTextView = new MyTextView(context, R.style.text, R.string.source_case_pulmonary_tb);
		sourceCaseHasPulmonaryTB = new MySpinner(context, getResources().getStringArray(R.array.four_options), R.string.source_case_pulmonary_tb, R.string.option_hint);
		
		sourceCasePositiveSputumSmearTextView = new MyTextView(context, R.style.text, R.string.source_case_positive_sputum_smear);
		sourceCasePositiveSputumSmear = new MySpinner(context, getResources().getStringArray(R.array.four_options), R.string.source_case_positive_sputum_smear, R.string.option_hint);
		
		moreThanOneSourceCaseTextView = new MyTextView(context, R.style.text, R.string.more_than_one_source_case);
		...
		sourceCaseQuestions = new View[] {sourceCaseMother, sourceCasePrimaryCareGiver, sourceCaseSleepSameBed, 
				sourceCaseSleepSameRoom, sourceCaseLiveSameHousehold, sourceCaseSeeChildEveryday, 
				sourceCaseCoughing, sourceCaseHasPulmonaryTB, sourceCasePositiveSputumSmear, moreThanOneSourceCase};
			...
			if (!patId.equals (""))
			{
				AsyncTask<String, String, String[][]> getTask = new AsyncTask<String, String, String[][]> ()
				{
					...
					protected void onPostExecute (String[][] result)
					{
						...
						{
							saveButton.setEnabled(false);
							App.getAlertDialog (PaediatricContactTracingActivity.this, AlertType.ERROR, indexCaseId.getTag().toString() +": " + getResources ().getString (R.string.item_not_found)).show ();
						}
					}
				};
				getTask.execute ("");
			...
			if(screenedBefore.getSelectedItem().toString().equals(getResources().getString(R.string.yes)))
			{
				...
				OnClickListener listener = new OnClickListener ()
				{
					...
					public void onClick (DialogInterface dialog, int which)
					{
						dialog.dismiss ();
						finish();
						Intent mainMenuIntent = new Intent (PaediatricContactTracingActivity.this, MainMenuActivity.class);
...
//			}
	...
	public boolean submit()
	{
		...
		if (validate ())
		{
			...
			observations.add(new String[] {"Other Examination",  App.get(otherExamination)});
			observations.add(new String[] {"BCG Scar", App.get(childBcgScar)});
			observations.add(new String[] {"Adult Family Member TB", App.get(adultFamilyMemberTB)});
			
			if(adultFamilyMemberTB.getSelectedItem().toString().equals(getResources().getString(R.string.yes)))
			{
				observations.add(new String[] {"Member TB", App.get(memberFamilyTB)});
				observations.add(new String[] {"Family TB Form", App.get(memberTBForm)});
				observations.add(new String[] {"Family TB Type", App.get(memberTBType)});
				observations.add(new String[] {"Sputum Smear Positive TB", App.get(confirmSputumSmearPositiveTB)});
			}
			observations.add(new String[] {"Exposure Score", App.get(exposureScore)});
			observations.add(new String[] {"Source Case Child Mother", App.get(sourceCaseMother)});
			observations.add(new String[] {"Source Primary Care Giver", App.get(sourceCasePrimaryCareGiver)});
			observations.add(new String[] {"Source Case Seeing Child", App.get(sourceCaseSeeChildEveryday)});
			observations.add(new String[] {"Source Case Living", App.get(sourceCaseLiveSameHousehold)});
			observations.add(new String[] {"Source Case Sleep Room", App.get(sourceCaseSleepSameRoom)});
			observations.add(new String[] {"Source Case Sleep", App.get(sourceCaseSleepSameBed)});
			observations.add(new String[] {"Source Case Cough", App.get(sourceCaseCoughing)});
...
//			observations.add(new String[] {"TB Suspect", tbSuspect.isChecked() ? "Yes" : "No" });
			...
			AsyncTask<String, String, String> updateTask = new AsyncTask<String, String, String> ()
			{
				...
				protected String doInBackground (String... params)
				{
					...
					String result = "";
					if(tbSuspect.isChecked())
						result = serverService.savePaediatricContactTracing(FormType.PAEDIATRIC_CONTACT_TRACING, values, observations.toArray (new String[][] {}));
					else
				...
				protected void onPostExecute (String result)
				{
					...
					{
						App.getAlertDialog(PaediatricContactTracingActivity.this, AlertType.INFO, getResources().getString(R.string.inserted)).show();
						initView(views);
					}
					else
					{
						App.getAlertDialog (PaediatricContactTracingActivity.this, AlertType.ERROR, result).show ();
					}
				}
			};
			updateTask.execute ("");
