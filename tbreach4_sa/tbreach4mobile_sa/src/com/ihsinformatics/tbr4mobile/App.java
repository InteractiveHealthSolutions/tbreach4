...
public class App
{
	...
	public static String getScreeningType() {
		return screeningType;
	}

	public static void setScreeningType(String screeningType) {
		App.screeningType = screeningType;
	}

	public static String getScreeningStrategy() {
