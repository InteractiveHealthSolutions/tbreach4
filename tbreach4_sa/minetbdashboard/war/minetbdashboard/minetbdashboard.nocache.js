...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "minetbdashboard" because\n';
  ...
  $wnd.__gwt_activeModules['minetbdashboard'] = {
    'moduleName' : 'minetbdashboard',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/minetbdashboard.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['minetbdashboard'].superdevmode = true;

  var expectedSuffix = '/minetbdashboard.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + minetbdashboard + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:minetbdashboard';
  var devModeSessionKey = '__gwtDevModeSession:minetbdashboard';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/minetbdashboard/minetbdashboard.nocache.js';
  ...
  $wnd.__gwt_activeModules['minetbdashboard'].canRedirect = true;
  $wnd.__gwt_activeModules['minetbdashboard'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING minetbdashboard';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/minetbdashboard?user.agent=' + ua + '&_callback=' + callback;
