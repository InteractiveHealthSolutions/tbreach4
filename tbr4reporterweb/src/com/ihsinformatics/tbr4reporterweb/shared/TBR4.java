...
package com.ihsinformatics.tbr4reporterweb.shared;
 ...
 * 
 */
public final class TBR4 {
	public static final String hashingAlgorithm = "SHA";
	public static final String packageName = "com.ihsinformatics.tbr4reporterweb";
	public static final String projectTitle = "Dashboard for TB REACH - Kotri";
	public static final char separatorChar = ',';
	public static final int sessionLimit = 900000;
	public static final TBR4 xsms = new TBR4();
	...
	public static String concatenateArray(String[] array) {
		...
		for (String s : array) {
			...
			concatenated.append(TBR4.separatorChar);
		}
	...
	public static void setCurrentUser(String currentUser) {
		TBR4.currentUser = currentUser.toUpperCase();
	}
