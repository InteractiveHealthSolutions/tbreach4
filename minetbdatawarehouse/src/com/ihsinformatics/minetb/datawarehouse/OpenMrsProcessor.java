...
public class OpenMrsProcessor extends AbstractProcessor {
	...
	String[] sourceTables = { "active_list_type", "cohort", "cohort_member",
			...
			"concept_numeric", "concept_proposal", "concept_proposal_tag_map",
			"concept_reference_map", "concept_reference_source",
			"concept_reference_term", "concept_reference_term_map",
			"concept_set", "concept_set_derived", "concept_state_conversion",
			"concept_stop_word", "concept_word", "drug", "drug_ingredient",
			"drug_order", "encounter", "encounter_provider", "encounter_role",
			"encounter_type", "field", "field_answer", "field_type", "form",
			"form_field", "form_resource", "global_property", "location",
